...
@main.route('/api/menu_management/data/all', methods=["GET"])
def getListDishes():
...
@main.route('/api/menu_management/data', methods=['POST'])
def addDish():
    # Open data
    SITEROOT = os.path.realpath(os.path.dirname(__file__))
...
@main.route('/api/menu_management/data/delete', methods=['POST'])
def removeDish():
    # Open data
    SITEROOT = os.path.realpath(os.path.dirname(__file__))
    jsonUrl_dishes = os.path.join(SITEROOT, "data", "foods.json")
